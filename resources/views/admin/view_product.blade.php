...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      {{Form::open(array('url'=>'admin/update_service','method'=>'post','enctype'=>'multipart/form-data'))}}
        ...
        <div class="row" style="padding:2%">
         ...
         <div class="col-lg-3 col-6">
           ...
           <label>Product Name</label> 
            <input type="text" disabled name="service_name" value="<?=@$edit_data->service_name?>" placeholder="Product Name" class="form-control"></div>
            <div class="col-lg-3 col-6">
           <label>Product Price</label> 
            <input type="text" disabled name="service_price" value="<?=@$edit_data->service_price?>" placeholder="Product Price" class="form-control"></div>
          ...
          <div class="col-lg-12">
            ...
            <?php if($edit_data->image){ ?>
                <img src="<?php echo asset('/');?>uploads/service/<?=$edit_data->image?>">
            <?php } ?>
