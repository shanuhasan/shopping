        ...
        <div class="row" style="padding:2%">
         ...
         <div class="col-lg-6 col-6">
          ...
          <div class="col-lg-4 col-6">
           ...
           ?>
              <option  value="<?=$value->id?>"><?=$value->customer_name?> (<?=$value->email?>)</option>
            <?php } ?>
            </select>
          </div>
          <div class="col-lg-4 col-6">
          ...
          <div class="col-lg-6 col-6">
           <label>Near By Address</label> <span style="color:red">*</span>
            <input type="text" name="near_by_address" value="<?=@$_POST['near_by_address']?>" placeholder="Near By Address" class="form-control near_by_address">
           ...
           <label>Note</label>
            <input type="text" name="note" value="<?=@$_POST['note']?>" placeholder="Note" class="form-control">
          </div>
         ...
         <div class="col-lg-5 col-6">
            ...
            <div class="row services">
             <?php foreach ($services as $key => $value) { ?>
              <div class="col-lg-4 add_service" data-id="<?=$value->id?>">
                <?php if($value->image){ ?>
