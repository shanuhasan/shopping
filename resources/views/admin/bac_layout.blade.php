...
<head>
  ...
  <link rel="stylesheet" href="<?php echo asset('/');?>assets/bacend/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?php echo asset('/');?>assets/bacend/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
    ...
    <div class="sidebar">
        ...
        ?>
              <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                  <img src="{{url('/uploads/users/', Sentinel::getUser()->profile_image)}}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
      ...
      <?php }else{?> 
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img src="<?php echo asset('/');?>uploads/logo/1599827425.png" class="img-circle elevation-2" alt="User Image" style="width: 3.2rem;">
            </div>
            <div class="info">
         ...
         <li class="nav-item has-treeview {!!Request::segments()[1]=='order'?'menu-open':''!!}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <a href="{{url('admin/order/create')}}" class="nav-link {!!Route::getFacadeRoot()->current()->uri()=='admin/order/create'?'active':''!!}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New Orders</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview {!!Request::segments()[1]=='settings'?'menu-open':''!!} {!!Request::segments()[1]=='banners'?'menu-open':''!!}{!!Request::segments()[1]=='types'?'menu-open':''!!}">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-circle"></i>
              <p>
                General Setting
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <a href="{{url('admin/settings/site-settings')}}" class="nav-link {!!Route::getFacadeRoot()->current()->uri()=='admin/settings/site-settings'?'active':''!!}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Site Settings</p>
                </a> 
...
<script src="<?php echo asset('/');?>assets/bacend/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
  ...
  /* $('.near_by_address').keyup(function(){
   ...
   $('body').on('click','.append_address',function(){
    ...
    $('.view_address').html('');
     $.ajax({
      url:'{{url("admin/get_all_address")}}',
      type:'get',
      data:{'address':address,'parent_category':parent_category},
      success:function(data){ 
        $('.vendors').html(data);
      }
    });
   ...
   $('.parent_category').change(function(){
    ...
    $.ajax({
      ...
      type:'get',
      data:{'cat':cat,'near_by_address':near_by_address},
      success:function(data){ 
        $('.vendors').html(data);
      }
    });
...
<script>   
  ...
  $('body').on('click','.remove_rervice_item',function(){
    ...
    $.ajax({
      ...
      type:'get',
      data:{'vendor_id':vendor_id,'service_id':service_id},
      success:function(data){ 
  ...
  $('body').on('change','.change_status_booking',function(){
   ...
   $('body').on('click','.add_service',function(){
    ...
    $.ajax({
      ...
      type:'get',
      data:{'service_id':service_id,'vendor_id':vendors},
      success:function(data){ 
        if(data=='exist'){
    ...
    var favorite = [];
            ...
            if(favorite.length>0){
               $.ajax({
                      ...
                      type:'get',
                      data:{'arrays':favorite,'deliveryboy':deliveryboy},
                      success:function(data){ 
                       if(data=='success'){
    ...
    $('.variantimageupload').change(function(e) {
        ...
        $.ajax({
           url:'{{url("admin/uploadvariantimages")}}',
            ...
            data: formData,
            success: function(data) {
                var img='<img src="<?php echo asset('/');?>uploads/items/'+data+'" style="width:100px">';
