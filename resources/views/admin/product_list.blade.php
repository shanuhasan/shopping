                ...
                <tr>
                  ...
                  <td>
                    <?php if($value->status=='1'){ ?>
                      <a href="{{url('admin/product_active')}}/<?=$value->id?>" class="btn-success btn btn-sm">Active</a>
                    <?php }else{ ?>
                       <a href="{{url('admin/product_deactive')}}/<?=$value->id?>" class="btn-danger btn btn-sm">Deactive</a>
                    <?php } ?>
                  </td>
