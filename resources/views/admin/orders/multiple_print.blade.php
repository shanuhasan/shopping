                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <td>{{number_format((float)$item->quantity, 2, '.', '')}}  x {{$item->unit_value}}{{$item->unit}}</td>
                       ...
                       ?>
                       {{number_format((float)$item->quantity, 2, '.', '')}} {{$item->unit_value}}{{$item->unit}}
                       <?php } ?>
                       </td>
                ...
                <div class="col-6">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <th>Discount:</th>
                        <th>{{number_format((float)$orderdata->order_discount?$orderdata->order_discount:0.00, 2, '.', '')}}</th>
                      </tr>
                      <tr>
                        <th>Total:</th>
                        <th>INR {{number_format((float)$orderdata->grand_total, 2, '.', '')}}</th>
                      </tr>
                    </table>
                  </div>
