            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            {{ Form::open(['url' => 'admin/order/edit', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'order_form']) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="shipping" required
                                            value="{{ number_format((float) $order->shipping, 2, '.', '') }}" id="shipping"
                                            class="form-control" data-placeholder="Shipping" readonly>
                                    </div>
                                </div>
                            </div>
