...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Send link reset your password</p>

     {{Form::open(array('url'=>'vendor/reset-password','method'=>'post'))}}
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block form-control">Send Link </button>
          </div>
          <!-- /.col -->
        </div>
      </form>
