                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.subcategory.create') }}">Add
                                    SubCategory</a>
                            </li>
                    ...
                    if($value->parent_id>0){?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.subcategory.active', $value->id) }}"
                                                    class="btn-success btn btn-sm">Active</a>
                                                <?php }else{ ?>
                                                <a href="{{ route('admin.subcategory.deactive', $value->id) }}"
                                                    class="btn-danger btn btn-sm">Deactive</a>
                                                <?php } ?>
                                            </td>
                                            <td><a href="{{ route('admin.subcategory.edit', $value->id) }}"
                                                    class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"
                                                        aria-hidden="true"></i></a>
                                                <a onclick="return confirm('Are you sure delete this record ?..')"
                                                    href="{{ route('admin.subcategory.delete', $value->id) }}"
